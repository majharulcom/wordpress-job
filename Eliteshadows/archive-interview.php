                    ...
                    while (have_posts()) {
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 interviw-page">
                            <div class="event-img">
                                ...
                                <a href="<?php echo get_permalink(); ?>"><img title="<?php echo get_the_title(); ?>" alt="<?php echo get_the_title(); ?>" src="<?php echo $image_attributes_news[0]; ?>"></a></div>
                            <h4><a href="<?php echo get_permalink(); ?>"><?php echo get_the_title(); ?></a></h4>
                            <p><?php
                                $content = do_shortcode(get_the_content());
                                $trimmed = wp_trim_words($content, $num_words = 50, $more = '.......');
                                print_r($trimmed);
                                ?></p>
