                ...
                <div class="container">
                    <div class="row" >
                        ...
                        while (have_posts()) : the_post();
                            ...
                            if ($event_last_date_1 >= $current_date || get_post_type() !== 'our_events') {
                                $is_event = true;
                                            ...
                                            <div class="col-md-5 col-sm-6 col-xs-6">
                                                <div class="event-detail"> <div class="event-title">
                                                    ...
                                                    <div class="event-info">
                                                        <p><?php echo get_the_excerpt() ?: wp_trim_words(do_shortcode(get_the_content()), $num_words = 50, $more = '.......'); ?></p>
                                                        <span class="view-mor-btn" > <a class="common-btn" href="<?php echo get_permalink(); ?>">View More</a> </span>
                                                    </div>
                                                    <?php if($is_event){ ?>
                                                    <div class="buy-ticket"> <a  title="" href="<?php echo get_permalink(); ?>/#payment_url" >BUY TICKET</a> </div>
                                                    <?php } ?>
                                                    </div>
                                            </div>
                                        </div>
