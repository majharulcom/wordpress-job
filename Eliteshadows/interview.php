    ...
    <section class="mid-warper news-page">
        ...
        <div class="container">
          <div class="inner-container-bg">
			...
			<?php $args = array('posts_per_page' => -1,'post_type' => array('interview'),'post_status'=>'publish','paged' => $paged,'order'=>'desc');$query = new WP_Query ($args);while ( $query->have_posts() ) { $query->the_post();
...
?>
    ...
    <meta property="og:image"         content="<?php echo $image_attributes_news[0]; ?>" />
			 <div class="col-md-4 col-sm-6 col-xs-12 interviw-page">
...
<?php }else{ ?>
						 <div class="event-img"><a href="<?php echo get_permalink();?>"><img title="<?php echo get_the_title();?>" alt="<?php echo get_the_title();?>" src="<?php echo get_template_directory_uri(); ?>/img/imagenotfound.png"></a></div>		
						<?php } ?>
					
					 
					 <h4><a href="<?php echo get_permalink();?>"><?php echo get_the_title();?></a></h4>
					 <p><?php  $content= do_shortcode(get_the_content()); $trimmed = wp_trim_words( $content, $num_words = 50, $more = '.......' ); print_r($trimmed);?></p>
