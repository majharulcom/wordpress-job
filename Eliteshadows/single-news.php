...
$post_banner = false;
$banner_image = get_post_custom_values('banner_image');
if(!empty($banner_image))
    $post_banner = wp_get_attachment_image ((int)$banner_image[0], array(1600,600));

$post_banner = $post_banner ? : '<img src="'.get_template_directory_uri().'/img/event_slider.jpg">'

?>
<article class="mid-warper no-padding">
<section class="inner_slider event-slider event-main-detail"> <?php echo $post_banner; ?>
<div class="container">
...
<div class="container mid-warper no-padding">
<div class="row mid-warper no-padding">
...
echo '<p class="must-log-in">' .  sprintf( __( 'You must be <a href="%s">logged in</a> to post a comment.' ), get_page_link(153) ) . '</p>';
