...
<div class="event_part ev_right_date">
		<?php $evd = get_uf('right_event_date'); echo $evd; ?>
</div>
								...
								if ( taxonomy_exists( $name ) ) {
									...
									foreach ( $terms as $term ) {
										...
										foreach ($variations as $key => $value) {
											$p_vari_slug = implode('/', $value['attributes']);
											if ($term->slug == $p_vari_slug) { ?>
												<div class="con_price"> <?php print_attribute_radio( $checked_value, $term->slug, $term->name, $sanitized_name ); ?>
												<span class="custom_price"><?php echo $value['text_field']; ?></span> </div>
											<?php }
										}
									}
								} else {
