<?php
/*
Template Name: therm com sizing
*/
...
<span class="blue_head">Thermal Expansion Tank Sizing</span>

<table width="80%" border="0" cellpadding="0" cellspacing="4">
<tbody><tr><td colspan="3" align="left"><input type="radio" name="prodseries" value="residential" onclick="Javascript: location.href = '/resources-rewards/selection-tools/thermal-expansion-tank-sizing/';"> <b>Residential</b>
<input type="radio" name="prodseries" value="commercial" checked=""> <b>Commercial</b></td></tr>
<?php if(!empty($err)){ ?> <p class="err"> <?php echo $err; ?> </p> <?php }?>
<tr>
	<td align="left">Domestic Hot Water Volume</td>
	<td><input type="text" name="domhotwater" value="<?php echo $_POST['domhotwater']; ?>" size="5">Gallons <i>(Range: 10 - 10,000)</i></td>
</tr>
<tr>
	<td align="left">Water Heater Temperature</td>
	<td><select name="waterheattmp" class="waterheattmp">
...
<tr>
	<td align="left">Relief Pressure</td>
	<td><select name="reliefpress" class="reliefpress">
		<option value="">Select</option>
		<option value="100">100</option>
...
<tr>
	<td align="left">Supply Pressure</td>
	<td><select name="supplypress" class="supplypress">
		<option value="">Select</option>
...
<script language="Javascript">
    jQuery('.waterheattmp option[value="<?php echo $_POST['waterheattmp'] ?>"]').attr('selected','selected');
    jQuery('.reliefpress option[value="<?php echo $_POST['reliefpress'] ?>"]').attr('selected','selected');
    jQuery('.supplypress option[value="<?php echo $_POST['supplypress'] ?>"]').attr('selected','selected');
</script>
