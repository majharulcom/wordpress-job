...
<?php
/*
Template Name: therm res sizing
*/
...
<div class="container selection_con">
 ...
 <tbody><tr><td colspan="3" align="left">
   ...
   <input type="radio" name="prodseries" value="commercial" onclick="Javascript: location.href = '/resources-rewards/selection-tools/therm-com-sizing/';"> <b>Commercial</b></td></tr>
  <?php if(!empty($err)){ ?> <p class="err"> <?php echo $err; ?> </p> <?php }?>
 <tr>
 	<td align="left">Water Heater Size</td>
 	<td><select name="wheatsize" class="wheatsize">
 ...
 <tr>
 	<td align="left">Approx. Temp Setting</td>
 	<td><select name="tmpset" class="tmpset">
 		<option value="">Select</option>
 		<option value="120">120</option>
 ...
 <tr>
 	<td align="left">Approx City Pressure</td>
 	<td><select name="citypress" class="citypress">
 		<option value="">Select</option>
 		<option value="40">40</option>
 		<option value="60">60</option>
 		<option value="80">80</option>
 ...
 <script language="Javascript">
     jQuery('.wheatsize option[value="<?php echo $_POST['wheatsize'] ?>"]').attr('selected','selected');
     jQuery('.tmpset option[value="<?php echo $_POST['tmpset'] ?>"]').attr('selected','selected');
     jQuery('.citypress option[value="<?php echo $_POST['citypress'] ?>"]').attr('selected','selected');
 </script>
