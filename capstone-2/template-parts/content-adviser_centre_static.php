                                          ...
                                          if($check_if_this_member_can->can_i_read_post($post->ID) || current_user_can( 'administrator' )){
											...
											<div class="docman_document">
												<ul class="docc">
                                                    ...
                                                    <li><?php the_content(); ?> <span style="width: 30%; display: block; float: right;"><a href="<?php echo wp_get_attachment_url(); ?>" class="btn btn-large btn-default btn-block docman_download__button docman_track_download"> Download</a></span><span> <?php edit_post_link('Edit', '<p class="btn btn-default btn-small edit_btn_custom">', '</p>'); ?></span></li>
													<hr/>
												</ul>
											</div>
								<?php }}} wp_reset_query(); ?>
