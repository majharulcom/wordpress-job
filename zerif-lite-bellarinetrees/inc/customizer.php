...
function zerif_customize_register( $wp_customize ) {
	...
	/* attachment */
	$wp_customize->add_setting( 'zerif_attachment_email', array('sanitize_callback' => 'zerif_sanitize_text'));
			
	$wp_customize->add_control( 'zerif_attachment_email', array(
				'label'    => __( 'Attachment', 'zerif-lite' ),
				'section'  => 'zerif_contactus_section',
				'settings' => 'zerif_attachment_email',
				'priority'    => 6,
	));
