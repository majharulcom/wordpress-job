				...
				if( have_posts() ):
					...
					while( have_posts() ):
                        ...
                        <div id="<?php echo "portfolio-{$the_id}";?>" class="<?php echo $temp_class.$sort.$allow_space;?>">
                        	<figure>
                        		<?php $popup = 'http'.dttheme_ssl().'﻿://placehold.it/1170x878&text=Add%20Image%20/%20Video%20%20to%20Portfolio';
                        				...
                        				if( "video" === $item ) {
                        					...
                        					if( !empty($items) ) {
                        						...
                        						echo '<img src="http'.dttheme_ssl().'﻿://placehold.it/1170x878&text=Add%20Image%20/%20Video%20%20to%20Portfolio" width="1170" height="878" alt="" />';
                        					}
                        				} else {
