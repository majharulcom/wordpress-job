...
elseif( is_post_type_archive('dt_classes')):
	...
	if(function_exists('dynamic_sidebar') && dynamic_sidebar('custom-post-class-archives-sidebar-left') ): endif;
 
	$disable = dttheme_option('dt_class',"disable-everywhere-left-sidebar-for-class-archive");
	if( is_null($disable) ):
		if(function_exists('dynamic_sidebar') && dynamic_sidebar(('display-everywhere-sidebar-left')) ): endif;
	endif;
