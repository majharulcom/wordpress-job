	...
	function dttheme_show_dashbord_course_result($course_id) {
		...
		$out .= '<table border="0" cellpadding="0" cellspacing="10" style="width:100%;">
					<thead>
						<tr>
							<th scope="col">'.__('#', 'dt_themes').'</th>
							<th scope="col" class="dt-sc-align-left">'.__('Assignment', 'dt_themes').'</th>
							<th scope="col">'.__('Grade', 'dt_themes').'</th>
							<th scope="col">'.__('Status', 'dt_themes').'</th>
							<th scope="col">'.__('Option', 'dt_themes').'</th>
						</tr>
...
if( !function_exists( 'dttheme_get_quiz_statistics' ) ){
	function dttheme_get_quiz_statistics($quiz_id, $dt_grade_post_id, $page_type) {
		...
		$out .= '<div class="column dt-sc-one-fourth">';
			$out .= '<ul>';
				$out .= '<li class="dt-sc-quiz-total-questions"><label>'.esc_html__('Total', 'dt_themes').'</label> <span class="dt-sc-quiz-sepeartor"></span> <span class="dt-sc-quiz-question-result">'.$total_questions.'</span></li>';
				$out .= '<li class="dt-sc-quiz-skipped-questions"><label>'.esc_html__('Skipped', 'dt_themes').'</label> <span class="dt-sc-quiz-sepeartor"></span> <span class="dt-sc-quiz-question-result">'.$skipped_question.'</span></li>';
				$out .= '<li class="dt-sc-quiz-correct-answers"><label>'.esc_html__('Correct', 'dt_themes').'</label> <span class="dt-sc-quiz-sepeartor"></span> <span class="dt-sc-quiz-question-result">'.$correct_answers.'</span></li>';
				$out .= '<li class="dt-sc-quiz-wrong-answers"><label>'.esc_html__('Wrong', 'dt_themes').'</label> <span class="dt-sc-quiz-sepeartor"></span> <span class="dt-sc-quiz-question-result">'.$wrong_answers.'</span></li>';
			$out .= '</ul>';
		$out .= '</div>';
		$out .= '<div class="column dt-sc-one-fourth">';
			$out .= '<div class="dt-sc-quiz-time-taken"><label>'.esc_html__('Time Taken', 'dt_themes').'</label><span>'.$time_taken.'</span></div>';
		$out .= '</div>';
		$out .= '<div class="column dt-sc-one-fourth">';
			if($page_type != 'single') {
