...
function dttheme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'   				=> esc_url('https://s3.amazonaws.com/wedesignthemes/lms/designthemes-core-features.zip'), // The plugin source
		...
		array(
			'name'     				=> 'Layer Slider',
			'slug'     				=> 'LayerSlider',
			'source'   				=> 'https://s3.amazonaws.com/wedesignthemes/plugins/layer-slider/6.1.0/LayerSlider.zip',
			'version'				=> '6.1.0',
		...
		array(
			...
			'slug'     				=> 'revslider',
			'source'   				=> 'https://s3.amazonaws.com/wedesignthemes/plugins/revolution-slider/5.3.1.5/revslider.zip',
			'version'				=> '5.3.1.5'
		),
		...
		array(
			...
			'slug'     				=> 'js_composer',
			'source'   				=> 'https://s3.amazonaws.com/wedesignthemes/visual-composer/5.0.1/js_composer.zip',
			'version' 				=> '5.0.1',
		),
		...
		array(
			'name'		=>	'SCORM Cloud For WordPress',
			'slug'		=>	'scormcloud',
			'required'	=>	false
		),
