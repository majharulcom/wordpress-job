        ...
        <div class="j-pagetemplate-container">
            ...
            <div id="tpl-blog">
             ...
             <div id="tpl-courses">
                ...
                <div class="custom-box">
                    <div class="column one-sixth">                 
                        <label><?php _e('Layout Type','dt_themes');?></label>
                    </div>
                    <div class="column five-sixth last">   
                        <select name="mytheme-courses-layout-type">
                            <?php 
							$selected = array_key_exists("courses-layout-type",$tpl_default_settings) ?  $tpl_default_settings['courses-layout-type'] : '';
             ...
             <div id="tpl-classes">
                    ...
                    <div class="column five-sixth last">
                        <ul class="bpanel-post-layout bpanel-layout-set"><?php 
                            $posts_layout = array(	
                                ...
                                $v = array_key_exists("classes-post-layout",$tpl_default_settings) ?  $tpl_default_settings['classes-post-layout'] : 'one-third-column';
                        ...
                        <input id="mytheme-classes-post-layout" name="mytheme-classes-post-layout" type="hidden" value="<?php echo $v;?>"/>
                        <p class="note"> <?php _e("Choose layout style for your Classes",'dt_themes');?> </p>
                    </div>
                </div><!-- Post Playout End-->
                ...
                <div class="custom-box">
                    ...
                    <div class="column five-sixth last">   
                        <select name="mytheme-classes-post-per-page">
                            <option value="-1"><?php _e("All",'dt_themes');?></option>
                            <?php $selected = 	array_key_exists("classes-post-per-page",$tpl_default_settings) ?  $tpl_default_settings['classes-post-per-page'] : ''; ?>
                            <?php for($i=1;$i<=30;$i++):
                                echo "<option value='{$i}'".selected($selected,$i,false).">{$i}</option>";
                                endfor;?>
                        </select>
                        <p class="note"> <?php _e("Your classes pages show at most selected number of posts per page.",'dt_themes');?> </p>
                    </div>
                </div><!-- Classes Count End-->
	...
	function page_meta_save($post_id){
		...
		if ( defined('DOING_AUTOSAVE') && DOING_AUTOSAVE ) 	return $post_id;
			...
			elseif( "tpl-courses.php" == $_POST['page_template'] ):
				...
				$settings['courses-layout-type'] = $_POST['mytheme-courses-layout-type'];
				
			elseif( "tpl-classes.php" == $_POST['page_template'] ):
				$settings['classes-post-layout'] = $_POST['mytheme-classes-post-layout'];
				$settings['classes-post-per-page'] = $_POST['mytheme-classes-post-per-page'];
