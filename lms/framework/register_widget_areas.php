<?php 
	...
	if( $teacher_archives_layout != "content-full-width" ){
		if( $teacher_archives_layout == "with-left-sidebar" || $teacher_archives_layout == "both-sidebar" ){
			register_sidebar(array(
				'name' 			=>	sprintf(esc_html__('%s Archives Sidebar Left', 'dt_themes'), $GLOBALS['teachers-singular-label']),
				'id'			=>	'custom-post-teacher-archives-sidebar-left',
				'description'   =>  sprintf(esc_html__('%s archives sidebar that appears on the left.', 'dt_themes'), $GLOBALS['teachers-singular-label']),
				'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
				'after_widget' 	=> 	'</aside>',
				'before_title' 	=> 	'<h3 class="widgettitle">',
				'after_title' 	=> 	'<span></span></h3>'));
		...
		if( $teacher_archives_layout == "with-right-sidebar" || $teacher_archives_layout == "both-sidebar"){
			register_sidebar(array(
				'name' 			=>	sprintf(esc_html__('%s Archives Sidebar Right', 'dt_themes'), $GLOBALS['teachers-singular-label']),
				'id'			=>	'custom-post-teacher-archives-sidebar-right',
				'description'   =>  sprintf(esc_html__('%s archives sidebar that appears on the right.', 'dt_themes'), $GLOBALS['teachers-singular-label']),
				'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
				'after_widget' 	=> 	'</aside>',
				'before_title' 	=> 	'<h3 class="widgettitle">',
				'after_title' 	=> 	'<span></span></h3>'));
	...
	if( dttheme_is_plugin_active('designthemes-core-features/designthemes-core-features.php') ):
		...
		if( $class_archives_layout != "content-full-width" ){
			if( $class_archives_layout == "with-left-sidebar" || $class_archives_layout == "both-sidebar" ){
				register_sidebar(array(
					'name' 			=>	__("Class Archives Sidebar Left",'dt_themes'),
					'id'			=>	'custom-post-class-archives-sidebar-left',
					'description'   =>  __("Class archives sidebar that appears on the left.","dt_themes"),
					'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
					'after_widget' 	=> 	'</aside>',
					'before_title' 	=> 	'<h3 class="widgettitle">',
					'after_title' 	=> 	'<span></span></h3>'));
			...
			if( $class_archives_layout == "with-right-sidebar" || $class_archives_layout == "both-sidebar"){
				register_sidebar(array(
					'name' 			=>	__("Class Archives Sidebar Right",'dt_themes'),
					'id'			=>	'custom-post-class-archives-sidebar-right',
					'description'   =>  __("Class archives sidebar that appears on the right.","dt_themes"),
					'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
					'after_widget' 	=> 	'</aside>',
					'before_title' 	=> 	'<h3 class="widgettitle">',
					'after_title' 	=> 	'<span></span></h3>'));
