<?php
if( !function_exists( 'dttheme_add_members_to_group' ) ){
...
if( !function_exists( 'dttheme_remove_members_from_group' ) ){
...
if( !function_exists( 'dttheme_add_teacher_and_promote_as_admin' ) ){
