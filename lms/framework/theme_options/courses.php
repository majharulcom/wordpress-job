			...
			if(dttheme_option('general', 'disable-theme-default-courses') != 'true') { ?>
                <div class="bpanel-box">
                    ...
                    <div class="box-content">
                        ...
                        <div class="hr_invisible"> </div>
                        <div class="column one-third"><label><?php _e('Enable Email Notifications For New Lessons','dt_themes');?></label></div>
                        <div class="column two-third last">
                            ...
                            <div data-for="enable-email-notifications-newlessons" class="checkbox-switch <?php echo $switchclass;?>"></div>
                            ...
                            <p class="note"><?php _e('If you wish you can enable email notifications for new lessons to student.','dt_themes');?></p>
                            
                        </div>

                        <div class="hr_invisible"> </div>
                        <div class="column one-third"><label><?php _e('Enable Email Notifications For New Lessons - Content','dt_themes');?></label></div>
                        <div class="column two-third last">
                          ...
                          name="mytheme[dt_course][enable-email-notifications-newlessons-content]"><?php echo stripslashes(dttheme_option('dt_course','enable-email-notifications-newlessons-content'));?></textarea>
                            ...
                            <p class="note"><?php _e('Add content for your new lesson notification. To add the lesson and course content dynamically use below shortcodes.','dt_themes');?></p>
                            <p class="note"><strong><?php echo '[dt_notification_lesson_title] : '; ?></strong><?php _e('Adds current lesson title.','dt_themes');?></p>
                            <p class="note"><strong><?php echo '[dt_notification_course_title] : '; ?></strong><?php _e('Adds current course title.','dt_themes');?></p>
