...
<div id="widgetarea" class="bpanel-content">
  ...
  <div class="bpanel-main-content">
    <ul class="sub-panel widget-area-nav">
      ...
      <li><a href="#custom-widget-area-mega-menu"><?php _e("For Mega Menu",'dt_themes');?></a></li>
    </ul>
    ...
    <div id="custom-widget-area-mega-menu" class="tab-content">
      <div class="bpanel-box">
        ...
        <div class="box-content">
          ...
          <div class="bpanel-option-set">
            <input type="button" value="<?php _e('Add New Widget Area','dt_themes');?>" id="megamenu" class="black mytheme_add_widgetarea" />
            <div class="hr_invisible"></div><?php
