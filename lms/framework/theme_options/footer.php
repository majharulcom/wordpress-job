        ...
        <div id="my-footer" class="tab-content">
            ...
            <div class="bpanel-box">
                ...
                <div class="box-content">
                    ...
                    <h6><?php esc_html_e('Footer Background Image', 'dt_themes');?></h6>
                    ...
                    <p class="note"><?php esc_html_e('Upload an image for footer background, or specify the image url directly', 'dt_themes');?></p>
                    <div class="clear"></div>
                    ...
                    <div class="column one-half">
                        ...
                        <div class="bpanel-option-set">
                          <label><?php esc_html_e('Background Image Repeat', 'dt_themes');?></label>
                          <div class="clear"></div>
                          <select name="mytheme[general][footer-bg-repeat]">
                              ...
                              <?php foreach($bg_settings as $option):?>
                                  <option value="<?php echo esc_attr($option);?>"
                                      <?php selected($option,dttheme_option('general', 'footer-bg-repeat')); ?>><?php echo $option;?></option>
                              <?php endforeach;?>
                          </select>
                          <p class="note"><?php esc_html_e("Select how would you like to repeat the background image", 'dt_themes');?></p>
                    ...
                    <div class="column one-half last">
                        ...
                        <div class="bpanel-option-set">
                          <label><?php esc_html_e('Background Image Position', 'dt_themes');?></label>
                          <div class="clear"></div>
                          <select name="mytheme[general][footer-bg-position]">
                              <option value=""><?php esc_html_e("Select", 'dt_themes');?></option>
                              <?php foreach($bg_settings as $option):?>
                                  <option value="<?php echo esc_attr($option);?>"
                                      <?php selected($option,dttheme_option('general', 'footer-bg-position')); ?>><?php echo $option;?></option>
                              <?php endforeach;?>
                          </select>
                          <p class="note"><?php esc_html_e("Select how would you like to position the background", 'dt_themes');?></p>
                          <div class="hr_invisible"> </div>
                        </div>
