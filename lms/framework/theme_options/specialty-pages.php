...
<div id="specialty-pages" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
         ...
         <?php $sub_menus = array(
					...
					array("title"=>sprintf(esc_html__('%s Archives', 'dt_themes'), $GLOBALS['teachers-singular-label']), "link"=>"#teacher-archives"),
		...
		$tabs = array(
				...
				array(  "id"=>"teacher-archives", 
						"layout-title"=>sprintf(esc_html__('%s Custom Post\'s Archive Page Layout', 'dt_themes'), $GLOBALS['teachers-singular-label']),
						"layout-tooltip"=>sprintf(esc_html__('You can choose between a left, right or no sidebar layout for the %s custom post\'s Archive page.', 'dt_themes'), $GLOBALS['teachers-singular-label']),
						"post-layout-title" => __("Posts Layout",'dt_themes'),
						"post-layout-tooltip"=>__("Your archive results will use the layout you select below.",'dt_themes'),                                
