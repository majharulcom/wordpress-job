...
<div id="integration" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
        <ul class="sub-panel">   
            ...
            <li><a href="#integration-courses"><?php _e("Courses",'dt_themes');?></a></li>
        </ul>
	  ...
	  <?php endforeach;?>
        ...
        <div id="integration-courses">
            ...
            <div class="bpanel-box">
               ...
               <div class="box-content">
               <p class="note no-margin"><?php _e("Manage social media bookmark options and its layout to show in the courses.",'dt_themes');?></p>
               <?php global $dttheme_social_bookmarks;
                      $count = 1;
                      foreach($dttheme_social_bookmarks as $social_bookmark):?>
                        <div class="one-half-content <?php echo ($count%2 == 0)?"last":''; ?>">
                            <div class="bpanel-option-set">
                                ...
                                <?php $switchclass = (dttheme_option('integration',"sb-courses-".$social_bookmark['id'])<>'') ? 'checkbox-switch-on' :'checkbox-switch-off';?>
                                 <div data-for="<?php echo "sb-courses-".$social_bookmark['id'];?>" class="checkbox-switch <?php echo $switchclass;?>"></div>
                                 <input id="<?php echo "sb-courses-".$social_bookmark['id'];?>" type="checkbox"  value="<?php echo $social_bookmark['id'];?>" 
