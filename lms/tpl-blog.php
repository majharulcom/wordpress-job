							...
							<div class="entry-thumb">
                                ...
                                <?php if( $format === "image" || empty($format) ): ?>
                                        ...
                                        <?php if( has_post_thumbnail() ):
                                              ...
                                              elseif($pholder != 'on'):?>
                                                <img src="http<?php echo dttheme_ssl(); ?>://placehold.it/1170x822&text=<?php the_title(); ?>" alt="<?php printf(esc_attr__('%s'),the_title_attribute('echo=0'));?>" title="<?php printf(esc_attr__('%s'),the_title_attribute('echo=0'));?>" />
                                        <?php endif;?>
                                        </a>
