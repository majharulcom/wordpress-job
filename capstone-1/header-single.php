...
<body <?php body_class(); ?> >
  ...
  <?php $image = get_field('header_background'); ?>
<?php if($image) : ?><div class="banner_con_blog" style="background: url(<?php echo $image['url']; ?>) no-repeat !important; background-size: cover !important; background-position: top center !important;"><?php else : ?> <div class="banner_con_blog">	<?php endif; ?>
           ...
           <div class="blog_heading_con">
            ...
            <?php if (have_posts()) : ?>
                	...
                	<?php while (have_posts()) : the_post(); ?>
				            ...
				            <?php $other_second_heading = get_field('second_header'); ?>
                            <div class="col-md-6">
                            <h2 class="blog_heading"><?php the_title(); ?></h2>
                            <p class="blog_heading_para_s"><?php echo $other_second_heading; ?></p>
                          </div>
                	<?php endwhile; ?>
